"""
====================================================================================
config.py - Configuration for Media Service (SortedShelf)
====================================================================================
...
class Config:
    ...
    # Set the secret key for the Flask app, defaulting to 'dev' if not provided
    SECRET_KEY = os.getenv('SECRET_KEY', 'dev')

    # Set the database URI for SQLAlchemy, defaulting to a local SQLite database if not provided
    SQLALCHEMY_DATABASE_URI = os.getenv('DATABASE_URL', 'sqlite:///media.db')

    # Disable the modification tracking feature of SQLAlchemy to save resources
    SQLALCHEMY_TRACK_MODIFICATIONS = False

    # Port configuration for media service
