"""
====================================================================================
app.py - Flask Application Factory for Collection Service (SortedShelf)
====================================================================================
...
Purpose:
  ...
  - Registers routes and models for collection microservice
...
Usage:
  - Entry point for running the collection microservice
...
def create_app():
    """
    Application factory function for the Collection Service.
